    ...
    if model_name == 'Linear Regression':
        ...
        with st.container(border=True):
            ...
            with col2:
                ...
                learning_rate_init_0 = st.number_input('**Learning Rate Init (0.0001 - 1.0)**', min_value=0.0001, max_value=1.0, value=0.001, step=0.0001, format="%.4f", key='mlp_r_learning_rate_init_0', on_change=sync_values)
            ...
            with col4:
                ...
                learning_rate_init_1 = st.number_input('**Learning Rate Init (0.0001 - 1.0)**', min_value=0.0001, max_value=1.0, value=0.1, step=0.001, format="%.4f", key='mlp_r_learning_rate_init_1', on_change=sync_values)
                alpha_1 = st.number_input('**Alpha (0.0001 - 0.1)**', min_value=0.0001, max_value=0.1, value=0.1, step=0.0001, format="%.4f", key='mlp_r_alpha_1', on_change=sync_values)
