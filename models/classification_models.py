    ...
    if model_name == 'Logistic Regression':
        ...
        with st.container(border=True):
            ...
            with col4:
                ...
                learning_rate_init_1 = st.number_input('**Learning Rate Init (0.0001 - 1.0)**', min_value=0.0001, max_value=1.0, value=0.01, step=0.0001, format="%.4f", key='mlp_c_learning_rate_init_1', on_change=sync_values)
